    ...
    <div class="container">
        <div class="login">
            ...
            <div class="inputs">
                ...
                <button class="btn-login" v-on:click="EmployeeLogin($event)">Entrar</button>
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        EmployeeLogin(e) {
            ...
            axios.post("http://localhost:8081/employees/auth", user_data, { headers: { "Access-Control-Allow-Origin": "*", } })
                .then((res) => {
